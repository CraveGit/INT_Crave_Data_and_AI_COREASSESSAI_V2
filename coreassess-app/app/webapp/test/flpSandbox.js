		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "CoreAssess v2",
									"targetURL": "#comcravecoreassessv2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comcravecoreassessv2-display": {
								"semanticObject": "comcravecoreassessv2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.crave.coreassessv2",
									"url": sap.ui.require.toUrl("com/crave/coreassessv2")
								}
							}
						}
					}
